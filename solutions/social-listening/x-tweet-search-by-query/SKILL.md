...
description: Search X (Twitter) for posts mentioning a handle, replies to an account, and brand keywords. Collect post text, authors, engagement, and source links for sentiment analysis and social listening. Requires Browser Act and a logged-in X session.
---
